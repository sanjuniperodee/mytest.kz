...
const STRINGS: Record<string, { ru: string; kk: string }> = {
  ...
  billFooter: {
    ru: "Оплата через Kaspi: нажмите «Оформить», укажите номер Kaspi и оплатите выставленный счёт.",
    kk: "Kaspi арқылы төлеу: «Рәсімдеу» түймесін басып, Kaspi нөмірін енгізіп, берілген шотты төлеңіз.",
  },

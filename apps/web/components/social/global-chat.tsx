...
export function GlobalChatPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl" data-no-translate>
      <SocialNav />
      <h1 className="mb-4 hidden text-2xl font-semibold tracking-tight md:block">{t("Глобальный чат", "Жаһандық чат")}</h1>
      <div className="flex h-[calc(100dvh-15rem)] min-h-[440px] overflow-hidden rounded-xl border border-border/80 bg-background shadow-xs lg:h-[min(720px,calc(100dvh-13rem))]">
        {room ? (

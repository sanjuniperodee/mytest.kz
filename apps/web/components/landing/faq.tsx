...
const faqs = [
  ...
  },
  {
    ...
    a: "База поддерживается командой контента: новые задания добавляются, а спорные и устаревшие можно отправить на апелляцию прямо из разбора. Число активных заданий на главной показывается из реальной базы.",
  },
  {

...
export const metadata: Metadata = {
  ...
  description:
    "Сдавай пробные ЕНТ в реальном формате на mytest. Получай мгновенный балл, Premium-разбор ошибок, объяснения к каждому вопросу и аналитику по предметам. Готовься к ЕНТ 2026 умнее.",
  keywords: [
    "ЕNT",
    "пробный ЕNT",
    "тесты ЕNT",
  ...
  openGraph: {
    ...
    description:
      "Сдавай пробные ЕНТ в реальном формате. Мгновенный балл, Premium-разбор ошибок, объяснения к каждому вопросу и аналитика.",
    images: [
      {
        url: "/og-cover.svg",
        width: 1200,

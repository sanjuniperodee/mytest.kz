            ...
            },
            {
              ...
              children: (
                <div className="pg-subs__section">
                  ...
                  >
                    <div className="hig-table-card-intro">
              ...
              children: (
                <div className="hig-tab-panel-stack">
                  ...
                  <div className="pg-subs__section">
                    ...
                    <HigTableCard
                      title="Entitlements выбранного пользователя (v2)"
                    >
                      <div className="hig-table-card-intro">
                        <Select
                          showSearch

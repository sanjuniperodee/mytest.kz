...
export const NOTIFICATION_CAMPAIGNS: readonly NotificationCampaignDefinition[] = [
  ...
  },
  {
    ...
    cooldownHours: 24,
    message: {
      ru: 'До ЕНТ лучше готовиться по цифрам, а не наугад. Подключите Premium от 750 ₸, сдайте пробник и получите понятную картину по баллам.',
      kk: 'ҰБТ-ға дайындықты болжаммен емес, нақты нәтижемен бастаған дұрыс. 750 ₸-ден Premium қосып, сынақ тапсырып, баллыңыз бойынша нақты көрініс алыңыз.',
    },
  },
  {
  ...
  },
  {
    ...
    cooldownHours: 24,
    message: {
      ru: 'Не оставляйте результат просто цифрой. Сегодня можно открыть Premium со скидкой до 35% и пройти следующий ЕНТ уже с разбором слабых мест.',
      kk: 'Нәтижені жай сан күйінде қалдырмаңыз. Бүгін 35%-ға дейін жеңілдікпен Premium ашып, келесі ҰБТ-ны әлсіз жерлерді талдаумен тапсыра аласыз.',
    },
  },
  {
